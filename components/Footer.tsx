        ...
        Contact<span className='text-yellow-400'>-Me</span>
            ...
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>+2348106040478 <br/> +2348159718997</p>
                </div>
            </div>
            <div className='flex items-center space-x-6'>
                <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>adeolayisa32@gmail.com</p>
                </div>
            </div>
        </div>
